...
<div class="container my-3 py-5 text-center" style="background-color:powderblue;">
	<div class="panel panel-default">
		<div style="text-align:center; background-color: gray; " class="panel-heading pt-3 ">
			<label  ><h4 style="color: white;">Quiz test</h4></label>
		</div>
		...
		<div class="panel-body">
			...
			echo		'<div class=\'view overlay zoom\'>';
			echo			'<div class=\'card\' style=\'width: 100rem; height: 25rem;\'>';
			echo			'<div class=\'card bg-primary text-white\'>';
			echo			'</div>';
			echo				'<div class=\'card-body\'>';
			echo				'<br>';
			echo				'<h5  >'.$arr['question'].'</h5>';
			echo				'<hr>';
			echo				'<div class=\'checkbox\'><label><input type=\'checkbox\' >' .$arr['o1'].'</label></div>';
			echo				'<div class=\'checkbox\'><label><input type=\'checkbox\' >' .$arr['o2'].'</label></div>';
			echo				'<div class=\'checkbox\'><label><input type=\'checkbox\' >' .$arr['o3'].'</label></div>';
			echo				'<div class=\'checkbox\'><label><input type=\'checkbox\' >' .$arr['o4'].'</label></div>';
