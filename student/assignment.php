...
//File upload
$target_dir = "../teacher/studentAssignment/";
...
// if everything is ok, try to upload file
  ...
  if (move_uploaded_file($_FILES["files"]["tmp_name"], $target_file)) {
    ...
    echo "Sorry, there was an error uploading your file.";
				...
				$newcourse="INSERT INTO submission (assignment_file,assignment_date,assignment_time) VALUES('$target_file','$date','$time')";
...
<div class="content">
  <div class="col-sm-3">
    ...
    <div class="panel-body"> <!-- panel-body Begin -->
        <ul class="nav nav-pills nav-stacked category-menu"> <!-- nav nav-pills nav-stacked category-menu Begin -->
            <form  action="assignment.php" method="post" enctype="multipart/form-data" >
			 <label for="Select the video ">+ Add to create   </label>
			 <input type="file" id="files" name="files" multiple><br>
			<button type="submit" name="submit1" class="btn btn-default">Mark as done</button>
			</form>
    ...
    <div class="row-sm-2">
     <div class="panel panel-default sidebar-menu"> <!-- panel panel-default sidebar-menu Begin -->
    <div class="panel-heading"> <!-- panel-heading Begin -->
        <h3 class="panel-title">Private Comment</h3>
    </div> <!-- panel-heading finish -->
    
    <div class="panel-body"> <!-- panel-body Begin -->
        <div class="from-group row">
		<div class="col-xs-fluid">
		<input class="form-control" id="ex1"placeholder="Add Private Comment" type="text">
		</div>
		<div class="col-xs-2">
