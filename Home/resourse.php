			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="table-responsive table-bordered">
						...
						$sql=mysqli_query($conn,"select * from course_post where course_post_status='Public' ");
						while($row=mysqli_fetch_array($sql))
						{
							$FileType = strtolower(pathinfo($row['course_post_file'],PATHINFO_EXTENSION));
				...
				<div class="panel-body">
					...
					?>
								<td>
									...
									<?php  echo "File:  <a href=\"..\\teacher\\".htmlentities($row['course_post_file'])."\">Download file</a>"; ?>
								</td>
				...
				<div class="panel-body">
					...
					?>
								<td>
									...
									<?php echo "<br>File: <a href=\"..\\teacher\\uploads\\".htmlentities($row['course_post_file'])."\">Download file</a>";?>
								</td>
