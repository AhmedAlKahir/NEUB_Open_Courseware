...
<head>
	...
	<meta name="keywords" content="php,CSS,JavaScript,PHP">
...
<div class="btn-group">
  ...
  <?php
		if(isset($_REQUEST['register']))
		{
			...
			$email=$_REQUEST['t_email'];
			$pass=$_REQUEST['t_pass'];
			$designation=$_REQUEST['t_desi'];
			$website=$_REQUEST['t_website'];
			$address=$_REQUEST['t_address'];
			$image=$_FILES['t_image']['name'];
			$image_temp=$_FILES['t_image']['tmp_name'];
			 move_uploaded_file($image_temp,"regi_teacher_pic/$image");
			$join=$_REQUEST['t_join'];
			$status=$_REQUEST['t_status'];
			
			
						
						$registration="select * from teacher_registration where teacher_email ='$email'";
						...
						{
							$registration1="insert into teacher_registration values ('$name','$email','$pass','$designation','$website','$address','$image','$join','$status')";
                ...
                <div class="box"style="background-color:#3AAFA9"> <!-- box Begin -->
                    ...
                    <div class="box-header"> <!-- box-header Begin -->
                        ...
                        <center> <!-- center Begin -->
                            ...
                            <h2> Register a new account for Teacher</h2>

                        </center> <!-- center finish -->

                        <form action="teacherregister.php" method="post" enctype="multipart/form-data"> <!-- form Begin -->

                            <div class="form-group"> <!-- form-group Begin -->

                                <label> Name</label>

                                <input type="text" class="form-control" placeholder="Name" name="t_name" required>
                            ...
                            <div class="form-group"> <!-- form-group Begin -->
                                ...
                                <input type="text" class="form-control" placeholder="Email" name="t_email" required>
                            ...
                            <div class="form-group"> <!-- form-group Begin -->
                                ...
                                <input type="text" class="form-control" placeholder="Designation" name="t_desi" required>
                             ...
                             <div class="form-group"> <!-- form-group Begin -->
                                ...
                                <input type="text" class="form-control" placeholder="Website" name="t_website" required>

                            </div> <!-- form-group finish -->
							
							<div class="form-group"> <!-- form-group Begin -->

                                <label>Join University</label>

                                <input type="text" class="form-control" placeholder="Join University" name="t_address" required>
                            ...
                            <div class="form-group"> <!-- form-group Begin -->
                                ...
                                <input type="file" class="form-control form-height-custom" placeholder="Your Profile" name="t_image" id="t_image" required>
							...
							<div class="form-group"> <!-- form-group Begin -->
                                ...
                                <input type="text" class="form-control form-height-custom" placeholder=" Joining Date" name="t_join" required>
							...
							<div class="form-group"> <!-- form-group Begin -->
                                ...
                                <input type="text" class="form-control form-height-custom" placeholder=" Status" name="t_status" required>
