...
<?php 
	$sql=mysqli_query($conn,"SELECT DISTINCT university_name FROM university ORDER BY university_id");
...
?>
		<div class="col-sm-6 col-md-3">
				...
				<div class="card">
					...
					<div class="card-body"><h4><?php echo htmlentities($row['university_name']);?></h4></div>
				  </div>
				  <div class="card-body">
					<ol>
						<?php 
						$ch=$row['university_name'];
	$sql1=mysqli_query($conn,"SELECT * FROM university where university_name = '$ch'");
							while($row1=mysqli_fetch_array($sql1))
							{
						?>
						<li><a href="department_name.php"><?php echo htmlentities($row1['department_name']);?> </a></li>
						<?php 
							} 
						?> 
					</ol>
