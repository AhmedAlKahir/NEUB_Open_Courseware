...
<div class="wrapper" style="background-image: linear-gradient(white, black);">
 ...
 <?php
		...
		if(isset($_REQUEST['submit']))
		{
			...
			$loginQuery="SELECT * FROM teacher_registration WHERE  	teacher_email='$email' AND teacher_password='$password'";
...
?>
                ...
                <div class="box"style="background-color:#3AAFA9"> <!-- box Begin -->
                    ...
                    <div class="box-header"> <!-- box-header Begin -->
                        ...
                        <form action="teacherlogin.php" method="post" enctype="multipart/form-data"> <!-- form Begin -->
