  ...
  <div class="col-sm-3">
    ...
    <div class="row-sm-2">
		...
		<div class="panel panel-default sidebar-menu"> <!-- panel panel-default sidebar-menu Begin -->
			...
			<div class="panel-body"> <!-- panel-body Begin -->
				<div class="from-group" >
					<a href="assignment.php" >Assignment</a><br>
...
// if everything is ok, try to upload file
  ...
  if (move_uploaded_file($_FILES["files"]["tmp_name"], $target_file)) {
    ...
    echo "Sorry, there was an error uploading your file.";
				...
				$newcourse="INSERT INTO course_post (course_post_text,course_post_time,course_post_date,course_post_status,course_post_file) VALUES('$post','$time','$date','$option','$target_file')";
...
?>
			...
			<div class="col-sm-5 col-md-9">
				...
				<div class="card" >
				  ...
				  <div class="card-body">
					...
					<textarea name="post" class="form-control" rows="4" cols="4" id="post"  placeholder="share with your class" > </textarea>
				  </div>
				  ...
				  <div class="container" style="text-align:left"><!-- input-group Begin-->
						<span class="input-group-btn"><!-- input-group-btn Begin -->
							<select name="option" class="mdb-select md-form colorful-select dropdown-primary btn btn-default" >
								<option value="none">Share type</option>
	...
	{
?>
				<a style=""href="assigned.php" class="btn btn-primary" > 
