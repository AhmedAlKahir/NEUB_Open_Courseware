...
<div class="col-2-md-9">
	...
	<div class="panel panel-default">
		...
		<div style="text-align:center; background-color: #00b33c; " class="panel-heading pt-3 ">
			...
			<div>
			<ol><a href="# "style="color: white;">To Review </a></ol>		
			</div<div>
			<ol><a href="# "style="color: white;"> Reviewed </a></ol>			
			</div>
		 ...
		 <div class="panel-body">
							...
							<select class="form-control" >
								<option value="1">Student Work</option>
						 ...
						 <div class="col-sm-6 col-md-12">
							...
							<div class="card" >
								...
								<a style=""href="send.php" class="btn btn-primary" >Student work</a>
								<a style=""href="assigned.php" class="btn btn-primary" >Assignment</a>
