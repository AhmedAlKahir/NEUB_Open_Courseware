...
<h3 class="panel-title">North East University Bangladesh</h3>
</div> <!-- panel-heading finish -->
<br>
	<div class="row">
	
<?php
	$sql=mysqli_query($conn,"select * from teacher_registration");
...
?>
		...
		<div class="card">
		<div class="card-body">
			<img src="../Home/regi_teacher_pic/<?php echo htmlentities($row['teacher_image']);?>" alt=""class="img-fluid rounded-circle w-50 mb-3" style="width:120px; height:120px">
			<h3 style="color:#ff9900;"><?php echo htmlentities($row['teacher_name']);?></h3>
			
				<!-- <li><a href="department_name.php">Lecturer -->
			    <?php echo htmlentities($row['teacher_designation']);?><br>
				
				<?php echo htmlentities($row['teacher_status']);?><br>
				
				<?php echo htmlentities($row['teacher_address']);?><br>
				
				<?php echo "<a href=\"".htmlentities($row['teacher_website_link'])."\">".htmlentities($row['teacher_website_link'])."</a>";?><br>
				
				<?php echo htmlentities($row['teacher_join_date']);?>
