                     ...
                     <!-- Wrapper for carousel items -->
						     <div class="carousel-inner">
								  <div class="carousel-item active">
								      <img src="image/Courseware Graphic.jpg" alt="First Slide">
								</div>
								 <div class="carousel-item">
								      <img src="image/maxresdefault (1).jpg" alt="Second Slide">
								 </div>
								  <div class="carousel-item">
										<img src="image/Courseware Graphic.jpg" alt="Third Slide">
								 </div>
									</div>
									<!-- Carousel controls -->
