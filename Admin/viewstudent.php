...
<html lang="en">
  ...
  <body id="page-top">
	...
	<div class="row">
		...
		<div class="card">
		<div class="card-body">
			<img src="image/abu hanif.jpg"alt=""class="img-fluid rounded-circle w-50 mb-3">
			<h3 style="color:#ff9900;">Abu Hanif Numani</h3>
		...
		<div class="card">
		<div class="card-body">
			<img src="image/shahan.jpg"alt=""class="img-fluid rounded-circle w-50 mb-3">
			<h3 style="color:#ff9900;">Ahmed Shahan Shah</h3>
		...
		<div class="card">
		<div class="card-body">
			<img src="image/Mahmud Araf.jpg"alt=""class="img-fluid rounded-circle w-50 mb-3">
			<h3 style="color:#ff9900;"> Mahmud Araf </h3>
			
				
			   B.Sc. (Engg.) in CSE<br>
			   Dhaka University<br>
			   Contact:01766400690<br>
			  Email:Arafmah@gmail.com
		...
		<div class="card">
		<div class="card-body">
			<img src="image/mufassal.jpg"alt=""class="img-fluid rounded-circle w-50 mb-3">
			<h3 style="color:#ff9900;"> Mufassal Ahmad</h3>
